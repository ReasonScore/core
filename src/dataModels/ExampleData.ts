...
export function GenerateExampleData(): RsData {
  ...
  let rsData: RsData = {
    ...
    scores: [
      ...
      //No Scopes
      new Score(1 / 3, 1, ID("2      "), ID("2"), ID("0")),
      new Score(+1.00, 1, ID("2-3    "), ID("3"), ID("0")),
      new Score(+1.00, 1, ID("2-4    "), ID("4"), ID("0")),
      new Score(+1.00, 1, ID("2-5    "), ID("5"), ID("2")),

      // Scoped to claim 0
      new Score(+0.000, 1, ID("0      "), ID("0"), ID("0")),
      new Score(-1 / 3, 1, ID("0-2    "), ID("2"), ID("0")),
      new Score(-1.000, 1, ID("0-2-3  "), ID("3"), ID("0")),
      new Score(+1.000, 1, ID("0-2-4  "), ID("4"), ID("0")),
      new Score(+1.000, 1, ID("0-2-5  "), ID("5"), ID("0")),
      new Score(+1.000, 1, ID("0-2-3-6"), ID("6"), ID("0")),

      //Scoped to claim 1
      new Score(+0.000, 1, ID("1      "), ID("1"), ID("1")),
      new Score(-1 / 3, 1, ID("1-2    "), ID("2"), ID("1")),
      new Score(+1.000, 1, ID("1-2-3  "), ID("3"), ID("1")),
      new Score(+1.000, 1, ID("1-2-4  "), ID("4"), ID("1")),
      new Score(-1.000, 1, ID("1-2-5  "), ID("5"), ID("1")),
      new Score(+1.000, 1, ID("1-2-5-7"), ID("7"), ID("1")),
    ],
    history: [],
  }
  return rsData
